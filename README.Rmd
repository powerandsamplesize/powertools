...
and nonparametric tests of location.
Utilities are provided for computing various effect sizes. 

This package is a companion to the book, Crespi (2025) Power and Sample Size
in R, Chapman and Hall/CRC. That book uses this package as well as many 
other R packages. 
