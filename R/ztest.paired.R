...
#' @param sd2 The post standard deviation; defaults to the value of sd1.
...
ztest.paired <- function (N = NULL, delta = NULL,
                          sd1 = 1, sd2 = NULL, rho = NULL,
  ...
  # If sd2 is missing, default to sd1
